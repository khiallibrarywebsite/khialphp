...
<head>
    ...
    <title>مكتبة خيال | الكتّاب</title>
    <meta name="description" content="الوصف"/>
    <meta name="author" content="khiallibrary"/>
...
<div class="authContainer container-fluid d-flex justify-content-center flex-lg-wrap" style="flex-wrap: wrap;">
...
foreach ($getauth as $auth) {
    ...
    echo '
    <div class="col-sm-6 col-md-4 col-lg-3 mb-3"style="margin: 0 0 0 5px;">
        <div class="card">
          <img class="card-img-top" src="'.$AuthCover.'">
          <div class="card-body" style="    height: 250px;
    overflow: auto;">
            <h3 class="card-title"><a href="author.php?name='.$AuthName.'&id='.$id.'" style="text-decoration: none; color: #222; outline: none;">'.$AuthName.'</a></h3>
            <p class="card-text">'.$AuthDescription.'</p>
          </div>
        </div>
        </div>
    ';
