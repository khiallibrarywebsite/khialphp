...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9483470310411729" crossorigin="anonymous"></script>
        ...
        <ul class="d-flex list-unstyled mr-auto mb-0">
          <li class="nav-item active">
            <a class="nav-link" href="authors"
              >الأعمال الكاملة <span class="sr-only">(current)</span></a
            >
          </li>
          <li class="nav-item dropdown">
            <a
        class="nav-link" href="sections">الأقسام</a>
            <div
              id="dropdownMenu"
              class="dropdown-menu"
          ...
          <li class="nav-item">
            <a class="nav-link" href="we-are">من نحن</a>
          </li>
        </ul>
  ...
  <!-- Navbar -->
    <div class="container text-center">
      <img class="mt-3" src="images/lib.png" style="max-width: 100%; max-height: 100%;" alt="how-ARE" >
    </div>
    <footer>
      <div class="container">
        <a href="/">
 ...
 <a
              ...
              href="mailto:.support@khiallibrary.com"
              target="_blank"
              ><i class="fa fa-at"></i>
            </a>
            <a
              ...
              <img src="paypal.webp" alt="paypal" width="25">
            </a>
                        <a href="https://www.youtube.com/channel/UCEwcICZxM-ZsqYjmAnBwXdg" class="btn btn-sm" >
              <img src="youtube.png" alt="youtube" width="25">
            </a>
            </a>
